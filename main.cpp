...
const string M50_3[] = {
        "/home/jin/Lingqiu_Jin/A_star_pic/assets/Map50_3.bmp",
        "/home/jin/Lingqiu_Jin/A_star_pic/assets/Map50_3_Out.png",
        "/home/jin/Lingqiu_Jin/A_star_pic/assets/Map50_3_Path.png"
};
...
inline int diagonal_distance(MapNode* node1, MapNode* node2){
    return (node2->x - node1->x)*(node2->x - node1->x)+abs(node2->y - node1->y)*abs(node2->y - node1->y);
...
int main( int argc, char** argv ){
    ...
    // cout << "I am here " <<endl;
    map.at<Vec3b>(286, 308) = Vec3b(255, 0, 0);
    map.at<Vec3b>(190, 103) = Vec3b(0, 0, 255);
...
void drawPath(Mat &map, vector<MapNode *> path) {
    map = imread("/home/jin/Lingqiu_Jin/MapRead_08_15_2018/data/Map50_3_Out.png", CV_LOAD_IMAGE_COLOR); 
